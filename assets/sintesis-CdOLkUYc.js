import"./modulepreload-polyfill-B5Qt9EMX.js";import"./main-CS2dJC61.js";const i="https://cecc-sintesis-default-rtdb.firebaseio.com",c=document.querySelector("#container-app");fetch(`${i}/sintesiss.json`).then(e=>e.json()).then(e=>{if(!e){c.innerHTML=`
